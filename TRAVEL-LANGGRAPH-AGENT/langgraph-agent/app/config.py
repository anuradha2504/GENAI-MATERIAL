...
# Business booking persistence.
BOOKINGS_TABLE_ENABLED = os.getenv("BOOKINGS_TABLE_ENABLED", "true").lower() == "true"
BOOKINGS_TABLE_SETUP = os.getenv("BOOKINGS_TABLE_SETUP", "false").lower() == "true"
BOOKINGS_TABLE_NAME = os.getenv("BOOKINGS_TABLE_NAME", "bookings")
